...
public interface IBookMapperBackend {
     ...
     */
    public List<IBook> searchByTitleWord(String word); //return the title if you find a string
    //in the title that matches the user's search
